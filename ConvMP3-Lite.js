...
(async () => {
	...
	while (result == 'False') {
		result = await page2.evaluate(() => {
			...
			console.log("button1 : " + button + " | button 2 : " + button2);
	...
	nom = nom + '.mp3';
	console.log(" {".cyan.bgMagenta + name.cyan.bgMagenta.bold + "} ".cyan.bgMagenta + "Song file name : ".yellow + nom.yellow);
	...
	console.log(" {".cyan.bgMagenta + name.cyan.bgMagenta.bold + "} ".cyan.bgMagenta + " : " + "[==========100%]".blue);
	console.log("====================================================================================".green);
